...
/**
 * This class is an abstraction of a taxon's property. A property contains a
 * value that describes something about the taxon. The value can be :
 * <ul>
 * <li> A scalar: a single value. It is implemented as a
 * {@link java.lang.String}.</li>
 * <li> A {@link uk.ac.ebi.util.Table}: a bidimensional value, i.e. a matrix of
 * scalars.</li>
 * </ul>
 * 
 */
public class TaxonProperty {
   ...
   /**
    * The property's scalar value. It is <code>null</code> if
    * <code>_table</code> is not null.
    */
   private String _scalar;

   /**
    * The property's table value. It is <code>null</code> if
    * <code>_table</code> is not null.
    */
    ...
    * 
    * @return The scalar value or <code>null</code> if this property is not a
    *         scalar.
    */
    ...
    * 
    * @return The table value or <code>null</code> if this property is not a
    *         table.
    */
