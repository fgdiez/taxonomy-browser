...
public class TaxyController
{
    ...
    /** Gets the implementation of <code>TaxonomyPlugin</code> that is
     * currently in use.
     */
     ...
     * @return The plug-in chosen by the user or <code>null</code> if no selecting
     *         was made.
     */
    public TaxonomyPlugin resolvePlugins()
    {
        try
        {
            ...
            Class<TaxonomyPlugin> selectedPluginClass =
                selectPlugin( pluginClasses, pluginDescriptionClasses );
            ...
            TaxonomyPlugin selectedPlugin =
                (TaxonomyPlugin) selectedPluginClass.newInstance();
    ...
    public void connectToPlugin()
    {
        ...
        if( plugin != null )
        {
            ...
            System.err.println("Cannot resolve pluggins");
        }
    }
    ...
    /** Selects one of the available implementations of <code>TaxonomyPlugin</code>.
     */
