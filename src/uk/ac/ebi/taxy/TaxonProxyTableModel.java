...
public class TaxonProxyTableModel extends javax.swing.table.AbstractTableModel {
    ...
    */
   private final String[] _columnNames = { "Scientific Name", "ID" };

   /**
    * The collection of <code>TaxonProxy</code> that are the content of the
    * table.
    */
   private List<TaxonProxy> _taxa;
   ...
   public TaxonProxyTableModel() {
      ...
      _taxa = new ArrayList<TaxonProxy>();
   }

   /**
    * Sets the content of the table model. It sorts taxa alphabetically.
    * 
    * @param content
   ...
   /**
    * Gets the number of rows in the table model, which is the number of
    * contained taxa.
    * 
   ...
   public Object getValueAt( int rowIndex, int columnIndex) {
      ...
      TaxonProxy taxon = _taxa.get(rowIndex);
    ...
    */
   public Class<TaxonProxy> getColumnClass( int columnIndex) {

      return TaxonProxy.class;
   }
