...
public class MenuBar extends javax.swing.JMenuBar
{
    ...
    /** This class implements the action to be done
     * when clicking on the <i>Connect</i> menu item.
     */
    public class ConnectionAction extends AbstractAction
    {
         ...
         * Makes a new plug-in connection.
         *
         * @param e event.
         */
    ...
    /** This class implements the action to be done
     * when clicking on the <i>Disconnect</i> menu item.
     */
    public class DisconnectionAction extends AbstractAction
    {
        ...
        /**
         * Implementation of ActionListener.
         * Disconnects from the current plug-in.
         *
         * @param e event.
         */
        public void actionPerformed( ActionEvent e )
    ...
    /** This class implements the action to be done
     * when clicking on the <i>Exit</i> menu item.
     */
    ...
    /** This class implements the action to be done
     * when clicking on the <i>About</i> menu item.
     */
        ...
        implements javax.swing.event.HyperlinkListener
    {
        ...
        public void setPage( java.net.URL url )
        {
            ...
            {
                System.err.println( "Could not set the page " + url.toString() );
            }
        }
