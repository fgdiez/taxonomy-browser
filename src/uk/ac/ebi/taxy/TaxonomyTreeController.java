...
public class TaxonomyTreeController {
    ...
    */
   public TaxonomyTreeController( TaxonomyTreeUI ui, TaxonMetadataController taxonController, StatusBarController statusBarController) {
   ...
   /**
    * Notify that the specified taxon has been selected in the UI. The selection
    * happen on the <code>TaxonomyTreeUI</code> associated with this
    * controller and will be forwarded to the appropiate controllers.
    */
