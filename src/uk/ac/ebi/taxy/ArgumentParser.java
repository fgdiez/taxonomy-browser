...
/**
 * General purpose parser of command-line arguments. It allows to check for the
 * presence of an option and query the value associated to an option.
 */
public class ArgumentParser {
    ...
    * @return <code>true</code> if the option is present on the command-line
    ...
    * 
    * @return Either the value associated with a given option or
    *         <code>null</code> if there is no value associated with it.
    */
   public String getValue( String option) {

      String content = _options.get(option);

      return content;
   }

   /**
    * Checks the sintax of a token and determines if it is an option. It is an
    * option if the first character is a '-'.
    * 
    * @param token
    *           A sequence of characters with no white spaces.
   ...
   /**
    * Parse the command-line arguments and generate an internal easy-to-consult
    * representation.
    */
