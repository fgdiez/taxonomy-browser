...
/**
 * This class defines debugging utilities. 
 * It contains methods to help trace messages from the application execution,
 * as well as control facilities for exiting from the application.
 * 
 */
public class Debug
{
    ...
    /**
     * Check for a condition if the debugging is enabled. 
     * If the condition fails a message is shown and the program execution is aborted.
     * 
     * @param condition Condition to be checked
     * @param message   Message to be shown when condicion fails.
     */
    ...
    /**
     * Register an object that implements an <code>exit()</code> function.
     * This function should not have any arguments, otherwise it will not be 
     * registered. Once registered, it will be called back whenever the 
     * {@link Debug#exit Debug.exit()} function is called.
     * 
     * @param exitCallbackObject object to be called back when exiting 
     *                           the application.
    ...
    /**
     * Exit from the application. If there is a registered exit callback, 
     * it will call that function before doing the exit.
     */
