 ...
 * together with <code>TaxonomyPlugin</code>. The implementation must have
...
{
    /** Get the full name (with package path inclusive) of
     * the described <code>TaxonomyPlugin</code> implementation.
     */
